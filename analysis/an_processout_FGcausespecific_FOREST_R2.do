...
estimates use analysis/output/models/an_FG_causespecific_R2`outcome'_c`ctrl'_MATCHFACONLY
...
*FG GRAPHS OF NON-COMPETING OUTCOMES
gen counter=1
...
scatter graphorder shr if adjustment=="matchfac", m(Oh) msize(small) mcol(black) || rcap lci uci graphorder if adjustment=="matchfac", hor lw(thin) lc(black) ///
	...
	graph export analysis/output/an_processout_FGcausespecific_R2_FOREST.svg, as(svg) replace
