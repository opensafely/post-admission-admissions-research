...
cap log close
log using analysis/output/an_cox_causespecific_R2`csoutcome', replace t
...
estimates save analysis/output/models/an_cox_causespecific_R2`csoutcome'_c2019gp_MATCHFACONLY, replace
...
estimates save analysis/output/models/an_cox_causespecific_R2`csoutcome'_cflu_COMORBS_LSTYLE_ETHIMD, replace
...
estimates save analysis/output/models/an_cox_causespecific_R2`csoutcome'_c2019gp_COMORBS_LSTYLE_ETHIMD, replace
