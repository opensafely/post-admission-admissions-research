...
* Open a log file
cap log close
log using ./analysis/output/cr_create_2019pool_data_`poolnumber', replace t
...
gen patient_index_date = d(01/`poolnumber'/2019)
...
save ./analysis/cr_create_2019pool_data_`poolnumber', replace
