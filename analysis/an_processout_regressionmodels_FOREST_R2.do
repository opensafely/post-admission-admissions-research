...
preserve
	...
	|| line graphorder one if graphorder<=11, lp(dash) lc(red) ///
	||, xscale(log range(0.015 320)) xline(1, lp(dash)) xlab(0.5 1 2 5 10) xtitle(HR and 95% CI) ysize(8) ylab(, nogrid) ytitle("") yscale(off range(23)) legend(off) ///
