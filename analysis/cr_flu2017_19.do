...
* Open a log file
cap log close
log using ./analysis/output/cr_flu2017_19, replace t

clear
noi di "import delimited ./output/input_flu2017_19.csv"
import delimited ./output/input_flu2017_19.csv
...
order patient_id region stp imd age agegroup male ethnicity ethnicity_16 bmi bmicat obese4cat smoke_nomiss patient_index_date admitted1_date admitted1_reason discharged1_date admitted2_date admitted2_reason discharged2_date died_date_ons died_date_1ocare died_cause_ons died_ons_covid_flag
...
save ./analysis/cr_flu2017_19, replace
