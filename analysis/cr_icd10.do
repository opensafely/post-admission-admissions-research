...
outsheet using "C:\Github\post-admission-admissions-research\local-codelists\cr_icd10_circulatory.csv", c replace
restore
...
outsheet using "C:\Github\post-admission-admissions-research\local-codelists\cr_icd10_cancer_ex_nmsc.csv", c replace
restore
...
outsheet using "C:\Github\post-admission-admissions-research\local-codelists\cr_icd10_respiratory.csv", c replace
restore
...
outsheet using "C:\Github\post-admission-admissions-research\local-codelists\cr_icd10_digestive.csv", c replace
...
outsheet using "C:\Github\post-admission-admissions-research\local-codelists\cr_icd10_mentalhealth.csv", c replace
restore
...
outsheet using "C:\Github\post-admission-admissions-research\local-codelists\cr_icd10_nervoussystem.csv", c replace
restore
...
outsheet using "C:\Github\post-admission-admissions-research\local-codelists\cr_icd10_genitourinary.csv", c replace
restore
...
outsheet using "C:\Github\post-admission-admissions-research\local-codelists\cr_icd10_endocrine_nutritional_metabolic.csv", c replace
restore
...
outsheet using "C:\Github\post-admission-admissions-research\local-codelists\cr_icd10_external.csv", c replace
restore
...
outsheet using "C:\Github\post-admission-admissions-research\local-codelists\cr_icd10_otherinfections.csv", c replace
restore
...
outsheet using "C:\Github\post-admission-admissions-research\local-codelists\cr_icd10_musculoskeletal.csv", c replace
restore
